...
class CustomColors extends ThemeExtension<CustomColors> {
  ...
  CustomColors copyWith({
    ...
    return CustomColors(
      ...
      loadingIndicatorColor:
          loadingIndicatorColor ?? this.loadingIndicatorColor, font32Color: font32Color ?? this.font32Color,
    );
  }
  ...
  CustomColors lerp(ThemeExtension<CustomColors>? other, double t) {
    ...
    return CustomColors(
      ...
      loadingIndicatorColor:
          Color.lerp(loadingIndicatorColor, other.loadingIndicatorColor, t), font32Color: Color.lerp(font32Color, other.font32Color, t),
    );
  }
