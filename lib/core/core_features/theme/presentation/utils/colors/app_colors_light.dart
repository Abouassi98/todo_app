...
class AppColorsLight implements IAppColors {
  @override
  final Color primaryColor = const Color(0xffF5C92C);
  @override
  final Color primary = const Color(0xffCFA407);
  @override
  final Color secondary = const Color(0xFF4b98db);

  @override
  late final Color appBarBGColor = primaryColor;
  @override
  late final Color statusBarColor = Colors.transparent;
  @override
  ...
  @override
  late final Color textFieldFillColor =  const Color(0xffF5F5F5);
  @override
  ...
  @override
  final Color textFieldFocusedBorderColor = const Color(0xffF5C92C);
  @override
  ...
  @override
  late final Color buttonColor = primaryColor;
  @override
  ...
  @override
  final Color customFont32Color = const Color(0XFF181743);
  @override
